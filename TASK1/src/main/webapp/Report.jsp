...
div[class="a11"]:hover .ab1 {font-size: 15px;
							color: #92d3ed;
							}
div[class="a111"]:hover .ab1 {font-size: 15px;
							color: #92d3ed;
							}
.a11{
	position: relative;
...
<div class="admin">
<p style="font-size: 24px; margin-top: 40px;">Welcome, Admin</p>

</div>
<br>
<form action="MyServlet" method="post" style="padding: 50px;">
<input type="hidden" name="action" value="report">
<input type="hidden" name="actionreport1" value=0>
	<div style="display: flex; text-align: center;">
	<div class="a11">
		<button class="ab1" name="report" value="StRep">View Student Report</button>
	</div>
	<br>
	<div class="a111">
		<button class="ab1" name="report" value="SuRep">View Subject Report</button>
	</div>
</div>
</form>
</body>
